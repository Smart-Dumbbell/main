...
//                         children: [
//                           Text(
//                             'Goal Repetitions: ${repetitionsProvider.repetitions}',
//                             style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold),
//                           ),
//                           SizedBox(height: 10),
//                           LinearProgressIndicator(
//                             value: repetitionsProvider.repetitions_count.toDouble() /
//                                 repetitionsProvider.selectedRepetitions.toDouble(),
//                             minHeight: 10,
...
//                           SizedBox(height: 20),
//                           Text(
//                             'Current Repetitions: ${repetitionsProvider.repetitions}',
//                             style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold),
//                           ),
//                         ],
//                       );
